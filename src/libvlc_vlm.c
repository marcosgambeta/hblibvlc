...
{
  hb_retni(libvlc_vlm_add_broadcast(libvlc_par_instance(1), hb_parc(2), hb_parc(3), hb_parc(4), hb_parni(5), hb_parc(6), hb_parni(7), hb_parni(8)));
}
#endif
...
{
  hb_retni(libvlc_vlm_add_vod(libvlc_par_instance(1), hb_parc(2), hb_parc(3), hb_parni(4), hb_parc(5), hb_parni(6), hb_parc(7)));
}
#endif
...
{
  hb_retni(libvlc_vlm_del_media(libvlc_par_instance(1), hb_parc(2)));
}
...
{
  hb_retni(libvlc_vlm_set_enabled(libvlc_par_instance(1), hb_parc(2), hb_parni(3)));
}
...
{
  hb_retni(libvlc_vlm_set_output(libvlc_par_instance(1), hb_parc(2), hb_parc(3)));
}
...
{
  hb_retni(libvlc_vlm_set_input(libvlc_par_instance(1), hb_parc(2), hb_parc(3)));
}
...
{
  hb_retni(libvlc_vlm_add_input(libvlc_par_instance(1), hb_parc(3), hb_parc(4)));
}
...
{
  hb_retni(libvlc_vlm_set_loop(libvlc_par_instance(1), hb_parc(2), hb_parni(3)));
}
...
{
  hb_retni(libvlc_vlm_set_mux(libvlc_par_instance(1), hb_parc(2), hb_parc(3)));
}
...
{
  hb_retni(libvlc_vlm_change_media(libvlc_par_instance(1), hb_parc(2), hb_parc(3), hb_parc(4), hb_parni(5), hb_parc(6), hb_parni(7), hb_parni(8)));
}
#endif
...
{
  hb_retni(libvlc_vlm_seek_media(libvlc_par_instance(1), hb_parc(2), (float)hb_parnd(3)));
}
...
{
  hb_retni(libvlc_vlm_get_media_instance_time(libvlc_par_instance(1), hb_parc(2), hb_parni(3)));
}
...
{
  hb_retni(libvlc_vlm_get_media_instance_length(libvlc_par_instance(1), hb_parc(2), hb_parni(3)));
}
...
{
  hb_retni(libvlc_vlm_get_media_instance_rate(libvlc_par_instance(1), hb_parc(2), hb_parni(3)));
}
