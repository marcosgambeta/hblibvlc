...
{
  hb_retptr((libvlc_media_player_t *)libvlc_media_player_new_from_media(libvlc_media_par(1)));
}

// LIBVLC_API void libvlc_media_player_release( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_RELEASE)
{
  libvlc_media_player_release(libvlc_media_player_par(1));
}

// LIBVLC_API void libvlc_media_player_retain( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_RETAIN)
{
  libvlc_media_player_retain(libvlc_media_player_par(1));
}
...
{
  libvlc_media_player_set_media(libvlc_media_player_par(1), libvlc_media_par(2));
}

// LIBVLC_API libvlc_media_t * libvlc_media_player_get_media( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_MEDIA)
{
  hb_retptr((libvlc_media_t *)libvlc_media_player_get_media(libvlc_media_player_par(1)));
}

// LIBVLC_API libvlc_event_manager_t * libvlc_media_player_event_manager ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_EVENT_MANAGER)
{
  hb_retptr((libvlc_event_manager_t *)libvlc_media_player_event_manager(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_media_player_is_playing ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_IS_PLAYING)
{
  hb_retni(libvlc_media_player_is_playing(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_media_player_play ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_PLAY)
{
  hb_retni(libvlc_media_player_play(libvlc_media_player_par(1)));
}

// LIBVLC_API void libvlc_media_player_set_pause ( libvlc_media_player_t *mp, int do_pause )
HB_FUNC(LIBVLC_MEDIA_PLAYER_SET_PAUSE)
{
  libvlc_media_player_set_pause(libvlc_media_player_par(1), hb_parni(2));
}

// LIBVLC_API void libvlc_media_player_pause ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_PAUSE)
{
  libvlc_media_player_pause(libvlc_media_player_par(1));
}

// LIBVLC_API void libvlc_media_player_stop ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_STOP)
{
  libvlc_media_player_stop(libvlc_media_player_par(1));
}
...
{
  libvlc_video_set_format(libvlc_media_player_par(1), hb_parc(2), libvlc_unsigned_par(3), libvlc_unsigned_par(4), libvlc_unsigned_par(5));
}
...
{
  libvlc_media_player_set_nsobject(libvlc_media_player_par(1), (void *)hb_parptr(2));
}

// LIBVLC_API void * libvlc_media_player_get_nsobject ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_NSOBJECT)
{
  hb_retptr((void *)libvlc_media_player_get_nsobject(libvlc_media_player_par(1)));
}
...
{
  libvlc_media_player_set_xwindow(libvlc_media_player_par(1), (uint32_t)hb_parni(2));
}

// LIBVLC_API uint32_t libvlc_media_player_get_xwindow ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_XWINDOW)
{
  hb_retni((uint32_t)libvlc_media_player_get_xwindow(libvlc_media_player_par(1)));
}

// LIBVLC_API void libvlc_media_player_set_hwnd ( libvlc_media_player_t *p_mi, void *drawable )
HB_FUNC(LIBVLC_MEDIA_PLAYER_SET_HWND)
{
  libvlc_media_player_set_hwnd(libvlc_media_player_par(1), HB_ISPOINTER(2) ? (void *)hb_parptr(2) : (void *)hb_parnl(2));
}

// LIBVLC_API void *libvlc_media_player_get_hwnd ( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_HWND)
{
  hb_retptr((void *)libvlc_media_player_get_hwnd(libvlc_media_player_par(1)));
}
...
{
  libvlc_media_player_set_android_context(libvlc_media_player_par(1), (void *)hb_parptr(2));
}
...
{
  hb_retni(libvlc_media_player_set_evas_object(libvlc_media_player_par(1), (void *)hb_parptr(2)));
}
#endif
...
{
  libvlc_audio_set_format(libvlc_media_player_par(1), hb_parc(2), libvlc_unsigned_par(3), libvlc_unsigned_par(4));
}

// LIBVLC_API libvlc_time_t libvlc_media_player_get_length( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_LENGTH)
{
  hb_retnl((libvlc_time_t)libvlc_media_player_get_length(libvlc_media_player_par(1)));
}

// LIBVLC_API libvlc_time_t libvlc_media_player_get_time( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_TIME)
{
  hb_retnl((libvlc_time_t)libvlc_media_player_get_time(libvlc_media_player_par(1)));
}
...
{
  libvlc_media_player_set_time(libvlc_media_player_par(1), (libvlc_time_t)hb_parnl(2));
}

// LIBVLC_API float libvlc_media_player_get_position( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_POSITION)
{
  hb_retnd((float)libvlc_media_player_get_position(libvlc_media_player_par(1)));
}
...
{
  libvlc_media_player_set_position(libvlc_media_player_par(1), (float)hb_parnd(2));
}
...
{
  libvlc_media_player_set_chapter(libvlc_media_player_par(1), hb_parni(2));
}

// LIBVLC_API int libvlc_media_player_get_chapter( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_GET_CHAPTER)
{
  hb_retni(libvlc_media_player_get_chapter(libvlc_media_player_par(1)));
}
...
{
  hb_retni(libvlc_media_player_get_chapter_count(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_media_player_will_play( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_WILL_PLAY)
{
  hb_retni(libvlc_media_player_will_play(libvlc_media_player_par(1)));
}
...
{
  hb_retni(libvlc_media_player_get_chapter_count_for_title(libvlc_media_player_par(1), hb_parni(2)));
}
...
{
  hb_retni(libvlc_media_player_program_scrambled(libvlc_media_player_par(1)));
}

// LIBVLC_API void libvlc_media_player_next_frame( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_MEDIA_PLAYER_NEXT_FRAME)
{
  libvlc_media_player_next_frame(libvlc_media_player_par(1));
}
...
{
  libvlc_media_player_navigate((libvlc_media_player_t*)hb_parptr(1), libvlc_unsigned_par(2));
}
...
{
  libvlc_media_player_set_video_title_display(libvlc_media_player_par(1), (libvlc_position_t)hb_parni(2), (unsigned int)hb_parni(3));
}
...
{
  hb_retni(libvlc_media_player_add_slave(libvlc_media_player_par(1), (libvlc_media_slave_type_t)hb_parni(2), hb_parc(3), (bool)hb_parl(4)));
}
#endif
...
HB_FUNC(LIBVLC_VIDEO_GET_SIZE)
{
  unsigned px;
  unsigned py;
  hb_retni(libvlc_video_get_size(libvlc_media_player_par(1), libvlc_unsigned_par(2), &px, &py));
  hb_storni(px, 3);
  hb_storni(py, 4);
}
...
HB_FUNC(LIBVLC_VIDEO_GET_CURSOR)
{
  int px;
  int py;
  hb_retni(libvlc_video_get_cursor(libvlc_media_player_par(1), libvlc_unsigned_par(2), &px, &py));
  hb_storni(px, 3);
  hb_storni(py, 4);
}
...
{
  hb_retnd((float)libvlc_video_get_scale(libvlc_media_player_par(1)));
}

// LIBVLC_API void libvlc_video_set_scale( libvlc_media_player_t *p_mi, float f_factor )
HB_FUNC(LIBVLC_VIDEO_SET_SCALE)
{
  libvlc_video_set_scale(libvlc_media_player_par(1), (float)hb_parnd(2));
}
...
{
  libvlc_video_set_aspect_ratio(libvlc_media_player_par(1), hb_parc(2));
}
...
{
  hb_retni(libvlc_video_get_spu(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_video_get_spu_count( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_VIDEO_GET_SPU_COUNT)
{
  hb_retni(libvlc_video_get_spu_count(libvlc_media_player_par(1)));
}
...
{
  hb_retptr((libvlc_track_description_t *)libvlc_video_get_spu_description(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_video_set_spu( libvlc_media_player_t *p_mi, int i_spu )
HB_FUNC(LIBVLC_VIDEO_SET_SPU)
{
  hb_retni(libvlc_video_set_spu(libvlc_media_player_par(1), hb_parni(2)));
}
...
{
  hb_retptr((libvlc_track_description_t *)libvlc_video_get_track_description(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_video_get_track( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_VIDEO_GET_TRACK)
{
  hb_retni(libvlc_video_get_track(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_video_set_track( libvlc_media_player_t *p_mi, int i_track )
HB_FUNC(LIBVLC_VIDEO_SET_TRACK)
{
  hb_retni(libvlc_video_set_track(libvlc_media_player_par(1), hb_parni(2)));
}
...
{
  hb_retni(libvlc_video_take_snapshot(libvlc_media_player_par(1), libvlc_unsigned_par(2), hb_parc(3), (unsigned int)hb_parni(4), (unsigned int)hb_parni(5)));
}
...
{
  libvlc_video_set_deinterlace(libvlc_media_player_par(1), hb_parc(2));
}
...
{
  hb_retni(libvlc_video_get_marquee_int(libvlc_media_player_par(1), libvlc_unsigned_par(2)));
}
...
{
  libvlc_video_set_marquee_int(libvlc_media_player_par(1), libvlc_unsigned_par(2), (int)hb_parni(3));
}
...
{
  libvlc_video_set_marquee_string(libvlc_media_player_par(1), libvlc_unsigned_par(2), hb_parc(3));
}

// LIBVLC_API int libvlc_video_get_logo_int( libvlc_media_player_t *p_mi, unsigned option )
HB_FUNC(LIBVLC_VIDEO_GET_LOGO_INT)
{
  hb_retni(libvlc_video_get_logo_int(libvlc_media_player_par(1), libvlc_unsigned_par(2)));
}
...
{
  libvlc_video_set_logo_int(libvlc_media_player_par(1), libvlc_unsigned_par(2), hb_parni(3));
}
...
{
  libvlc_video_set_logo_string(libvlc_media_player_par(1), libvlc_unsigned_par(2), hb_parc(3));
}

// LIBVLC_API int libvlc_video_get_adjust_int( libvlc_media_player_t *p_mi, unsigned option )
HB_FUNC(LIBVLC_VIDEO_GET_ADJUST_INT)
{
  hb_retni(libvlc_video_get_adjust_int(libvlc_media_player_par(1), libvlc_unsigned_par(2)));
}
...
{
  libvlc_video_set_adjust_int(libvlc_media_player_par(1), libvlc_unsigned_par(2), hb_parni(3));
}
...
{
  hb_retnd((float)libvlc_video_get_adjust_float(libvlc_media_player_par(1), libvlc_unsigned_par(2)));
}
...
{
  libvlc_video_set_adjust_float(libvlc_media_player_par(1), libvlc_unsigned_par(2), (float)hb_parnd(3));
}
...
{
  hb_retni(libvlc_audio_output_set(libvlc_media_player_par(1), hb_parc(2)));
}
...
{
  hb_retptr((libvlc_audio_output_device_t *)libvlc_audio_output_device_enum(libvlc_media_player_par(1)));
}
...
{
  libvlc_audio_output_device_set(libvlc_media_player_par(1), hb_parc(2), hb_parc(3));
}
...
{
  libvlc_audio_toggle_mute(libvlc_media_player_par(1));
}

// LIBVLC_API int libvlc_audio_get_mute( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_AUDIO_GET_MUTE)
{
  hb_retni(libvlc_audio_get_mute(libvlc_media_player_par(1)));
}

// LIBVLC_API void libvlc_audio_set_mute( libvlc_media_player_t *p_mi, int status )
HB_FUNC(LIBVLC_AUDIO_SET_MUTE)
{
  libvlc_audio_set_mute(libvlc_media_player_par(1), hb_parni(2));
}

// LIBVLC_API int libvlc_audio_get_volume( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_AUDIO_GET_VOLUME)
{
  hb_retni(libvlc_audio_get_volume(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_audio_set_volume( libvlc_media_player_t *p_mi, int i_volume )
HB_FUNC(LIBVLC_AUDIO_SET_VOLUME)
{
  hb_retni(libvlc_audio_set_volume(libvlc_media_player_par(1), hb_parni(2)));
}

// LIBVLC_API int libvlc_audio_get_track_count( libvlc_media_player_t *p_mi )
HB_FUNC(LIBVLC_AUDIO_GET_TRACK_COUNT)
{
  hb_retni(libvlc_audio_get_track_count(libvlc_media_player_par(1)));
}
...
{
  hb_retc((const char *)libvlc_audio_equalizer_get_preset_name(libvlc_unsigned_par(1)));
}
...
{
  hb_retnd((float)libvlc_audio_equalizer_get_band_frequency(libvlc_unsigned_par(1)));
}
...
{
  hb_retptr((libvlc_equalizer_t *)libvlc_audio_equalizer_new_from_preset(libvlc_unsigned_par(1)));
}
...
{
  hb_retni(libvlc_audio_equalizer_set_amp_at_index(libvlc_equalizer_par(1), (float)hb_parnd(2), libvlc_unsigned_par(3)));
}
...
{
  hb_retnd((float)libvlc_audio_equalizer_get_amp_at_index(libvlc_equalizer_par(1), libvlc_unsigned_par(2)));
}
...
{
  hb_retni(libvlc_media_player_get_role(libvlc_media_player_par(1)));
}

// LIBVLC_API int libvlc_media_player_set_role(libvlc_media_player_t *p_mi, unsigned role)
HB_FUNC(LIBVLC_MEDIA_PLAYER_SET_ROLE)
{
  hb_retni(libvlc_media_player_set_role(libvlc_media_player_par(1), libvlc_unsigned_par(2)));
}
